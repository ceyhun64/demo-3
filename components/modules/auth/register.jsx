    ...
    <div className="w-full min-h-screen flex items-center justify-center bg-white px-4">
      <div className="w-full max-w-5xl grid md:grid-cols-2 border-gray-200">
        ...
        <div className="p-10 flex flex-col justify-center">
          <h2 className="text-4xl font-serif font-bold mb-8">Hesap Oluştur</h2>
        ...
        <div className="p-10 bg-white flex flex-col justify-center border-l border-green-500">
          <h2 className="text-4xl font-serif font-bold mb-4">
            Zaten hesabınız var mı?
          </h2>
          <p className="text-gray-600 mb-6 font-['Mozilla_Headline']">Hesabınıza giriş yaparak:</p>
